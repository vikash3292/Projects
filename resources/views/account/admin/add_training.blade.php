@extends('layouts.superadmin_layout')
   @section('content')
                                                      ...
                                                      <tr>
                                                         ...
                                                         <td>
                                                            <i class="mdi mdi-pen text-warning" data-toggle="modal"
                                                               data-target="#editemp{{$trainings->id}}" title="Edit"></i>
      ...
      <div id="editemp{{$trainings->id}}" class="modal fade show" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"  aria-modal="true" >
     <form method="post" id="edittrainingpage" enctype="multipart/form-data">
    <div class="modal-dialog modal-lg">
       <div class="modal-content">
          <div class="modal-header">
             <h5 class="modal-title mt-0" id="myModalLabel">Edit Training</h5>
             <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
          </div>
          ...
          <div class="modal-body">
            <div class="row">
                                       ...
                                       <div class="form-group row">
                                          ...
                                          <div class="col-lg-8">
                                             <select id="courseType" name="courseType" class="form-control">
                                                ...
                                                <option value="Certification" @if(!empty($trainings->coursetype)) @if($trainings->coursetype == 'Certification') selected @endif @endif>Certification</option>
                                                <option value="Training" @if(!empty($trainings->coursetype)) @if($trainings->coursetype == 'Training') selected @endif @endif>Training</option>
                                             </select>
                                             <div id="coursetype_error"></div>
                                          </div>
                                       </div>
                                    ...
                                    <input type="hidden" value="{{$trainings->id??''}}"  id="training_id" name="training_id">
                                    <div class="col-md-6">
                                       <div class="form-group row">
                                          <label for="colortype" class="col-lg-4 col-form-label">Course Level</label>
                                          <div class="col-lg-8">
                                             <select id="courselevel" name="courselevel" class="form-control">
                                                <option value="">--Please Select--</option>
                                                <option value="AE" @if(!empty($trainings->courselevel)) @if($trainings->courselevel == 'AE') selected @endif @endif>Basic</option>
                                                <option value="VI" @if(!empty($trainings->courselevel)) @if($trainings->courselevel == 'VI') selected @endif @endif>Advance</option>
                                             </select>
                                              <div id="courselevel_error"></div>
                                          </div>
                                 ...
                                 <div class="row">
                                    <div class="col-md-6">
                                       <div class="form-group row">
                                          <label for="colortype" class="col-lg-4 col-form-label">Training By</label>
                                          <div class="col-lg-8">
                                             <select class="form-control" name="trainingby" id="trainingby">
                                                <option @if(!empty($trainings->trainingby)) @if($trainings->trainingby == 'Umesh Joshi') selected @endif @endif>Umesh Joshi</option>
                                                <option  @if(!empty($trainings->trainingby)) @if($trainings->trainingby == 'Raghav') selected @endif @endif>Raghav</option>
                                             </select>
                                             <div id="trainingby_error"></div>
                                          </div>
                                       </div>
                                    ...
                                    <div class="col-md-6">
                                       <div class="form-group row">
                                          <label for="colortype" class="col-lg-4 col-form-label">From Date</label>
                                          <div class="col-lg-8">
                                             <input id="fromdate" value="{{$trainings->fromdate??'' }}" name="fromdate" type="date" class="form-control">
                                             <div id="fromdate_error"></div>
                                          </div>
                                       </div>
                                    </div>
                                 ...
                                 <div class="row">
                                    <div class="col-md-6">
                                       <div class="form-group row">
                                          <label for="colortype" class="col-lg-4 col-form-label">To Date</label>
                                          <div class="col-lg-8">
                                             <input id="todate" name="todate" value="{{$trainings->todate??'' }}" type="date" class="form-control">
                                               <div id="todate_error"></div>
                                          </div>
                                       </div>
                                    </div>
                                    <div class="col-md-6">
                                       <div class="form-group row">
                                          <label for="colortype" class="col-lg-4 col-form-label">Description</label>
                                          <div class="col-lg-8">
                                             <textarea id="descdata"  name="descdata" class="form-control">{{$trainings->descdata}}</textarea>
                                             <div id="descdata_error"></div>
                                          </div>
                                       </div>
                                    </div>
                                    <div class="col-md-6">
                                       <div class="form-group row">
                                          <label for="colortype" class="col-lg-4 col-form-label">Attachment</label>
                                          <div class="col-lg-8">
                                             <input  id="editfile" name="editfile" type="file" onchange="uploadeditimg('{{$trainings->id??''}}')">
                                          </div>
