                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-5">
                                                            <div class="form-group row m-t-10">
                                                                <label for="empcode" class="col-lg-3 col-form-label">Location:</label>
                                                                <div class="col-lg-9">
                                                         ...
                                                         <div class="col-sm-7">
                                                            <h6 class="m-0 padding-5 float-left width100">
                                                                <form role="search" class="app-search m-0 float-right" style="height: 0;">
                                                                    <div class="form-group mb-0">
                                                                        <input type="text" class="form-control m-0" placeholder="Search.." id="myInput" onkeyup="myFunction()">
                                    ...
                                    ?>
                                                        ...
                                                        @endforeach
                                                                                    ...
                                                                                    <th class="bg-naviblue text-center" colspan="8">
                                                                                        Allocation Hours
                                                                    in Week {{$currentweekCount??1}}</th class="p-10">
                                                                                </tr>
                                                                                 <tr
                                                                    ...
                                                                    <td class="text-left ">
                                                                     ...
                                                                     <td class="text-left">
                                                                      ...
                                                                      @endforeach
                                                                        ...
                                                                        <div class="col-sm-12 pagination_right">
