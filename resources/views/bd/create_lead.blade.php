                  ...
                  <div class="row align-items-center bredcrum-style">
                     <div class="col-sm-6">
                        ...
                        <ol class="breadcrumb">
                           ...
                           <li class="breadcrumb-item active"><a href="javascript: history.go(-1)">Create Lead</a></li>
                        </ol>
                     </div>
                  </div>
               </div>
                              ...
                              <div class="row">
                                 ...
                                 <div class="col-md-6">
                                    <div class="form-group row">
                                       ...
                                       <div class="col-lg-8">
                                          <input type="text" class="form-control" maxlength="10" name="p_phone_no" id="p_phone_no" onkeypress="preventNonNumericalInput(event)" maxlenght="10">
                                       </div>
                                    </div>
                                 </div>
                              </div>
                              <div class="row">
                                 <div class="col-md-6">
                                    <div class="form-group row">
                                       ...
                                       <div class="col-lg-8">
                                       <input type="text" class="form-control" maxlength="10"  name="a_phone_no" id="a_phone_no" onkeypress="preventNonNumericalInput(event)" maxlenght="10">
                                       </div>
                                    </div>
                                 </div>
                                 <div class="col-md-6">
                              ...
                              <div class="row">
                                 <div class="col-md-6">
                                    <div class="form-group row">
                                       ...
                                       <div class="col-lg-8">
                                          <input type="text" class="form-control" name="fax" id="fax" onkeypress="preventNonNumericalInput(event)">
                                       </div>
                                    </div>
                                 </div>
                                    ...
                                    <div class="form-group row">
                                       ...
                                       <div class="col-lg-8">
                                         <select class="form-control" name="industry" id="industry">
                                             <option>--None--</option>
                                             <option selected>Open Non Contacted</option>
                              ...
                              <div class="row">
                                    ...
                                    <div class="form-group row">
                                       ...
                                       <div class="col-lg-8">
                                          <select class="form-control" name="lead_status" id="lead_status">
                                             <option>--None--</option>
                                             <option value="1" selected>Open Non Contacted</option>
                                 ...
                                 <div class="col-md-6">
                                    <div class="form-group row">
                                       ...
                                       <div class="col-lg-8">
                                          <input type="text" class="form-control" name="annual_revenue" id="annual_revenue" onkeypress="preventNonNumericalInput(event)">
                                       </div>
                                    </div>
                                 </div>
                              </div>
                                    ...
                                    <div class="form-group row">
                                       ...
                                       <div class="col-lg-8">
                                          <input type="hidden" class="rating check"
                                             ...
                                             data-empty="mdi mdi-star-outline text-muted" name="rating" id="rating">
                                       </div>
                                    </div>
                                 </div>
                                 <div class="col-md-6">
                                    <div class="form-group row">
                                       ...
                                       <div class="col-lg-8">
                                          <input type="text" class="form-control" name="no_of_emp" id="no_of_emp" onkeypress="preventNonNumericalInput(event)">
                                       </div>
                                    </div>
                                 </div>
                              </div>
...
<script language="javascript" type="text/javascript">
    function submitDetailsForm() {
       ...
       if(zip.lenght !=6 && zip !=''){
          $('#zip_error').text('Zip is 6 Digit').attr('style','color:red');
          $('#zip_error').show();
            error = 0;
               return false;
       }else{$('#zip_error').hide();  error = 1;}
