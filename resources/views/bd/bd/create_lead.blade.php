                              ...
                              <div class="row">
                                 ...
                                 <div class="col-md-6">
                                    <div class="form-group row">
                                       ...
                                       <div class="col-lg-8">
                                          <input type="text" class="form-control" name="p_phone_no" id="p_phone_no" onkeypress="preventNonNumericalInput(event)" maxlenght="10">
                                       </div>
                                    </div>
                                 </div>
                              </div>
                              <div class="row">
                                 <div class="col-md-6">
                                    <div class="form-group row">
                                       ...
                                       <div class="col-lg-8">
                                       <input type="text" class="form-control"  name="a_phone_no" id="a_phone_no" onkeypress="preventNonNumericalInput(event)" maxlenght="10">
                                       </div>
                                    </div>
                                 </div>
                                 <div class="col-md-6">
