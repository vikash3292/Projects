                  ...
                  <div class="overflow-hidden account-card mx-3">
                     <div class="account-card-content">
                        <div class="text-center position-relative">
                           <h1 class="m-b-30">GRC GREEN ERP 11</h1>
                           <p class="m-b-30">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" class="form-horizontal m-t-30" action="{{URL::to('sendlink')}}" aria-label="{{ __('Reset Password') }}">
                        ...
                        <div class="row">
                              ...
                              <div class="col-11">
                        <input type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}"  name="email" value="{{ old('email') }}" required placeholder="Registered Email Id">
                        @if ($errors->has('email'))
