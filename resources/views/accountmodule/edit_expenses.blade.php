                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-8">
                                                     <input type="text" class="form-control"  id="expenses_name" name="expenses_name" value="{{$expense_edit->expense_name}}">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-8">
                                                    <select class="form-control" id="project_list" name="project_list">
                                                        ...
                                                        <option value="{{$project_lists->id}}" @if($expense_edit->project_id ==$project_lists->id )   selected @endif>{{$project_lists->project_name}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row">  
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-8">
                                                    <select class="form-control" id="category" name="category">
                                                        ...
                                                        @foreach($cat as $cats)
                                                        <option value="{{$cats->id}}"  @if($expense_edit->category_id ==$cats->id )   selected @endif>{{$cats->cat_name}}</option>
                                                        @endforeach
                                                    </select>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-8">
                                                    <input type="date" class="form-control" id="expenses_date" name="expenses_date"  value="{{$expense_edit->expeses_date}}">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-3 p-r-0">
                                                            <select class="form-control" name="currency" id="currency">
                                                                <option @if($expense_edit->currency =='INR' )   selected @endif>INR</option>
                                                                <option @if($expense_edit->currency =='USD' )   selected @endif>USD</option>
                                                            </select>

                                                        </div>
                                                        <div class="col-sm-9 p-l-0">
                                                            <input type="text" class="form-control" id="expenses_amt" name="expenses_amt"  value="{{$expense_edit->expenses_amt}}">
                                        ...
                                        <div class="col-md-6">
                                                ...
                                                <div class="col-lg-8">
                                                    <span>
                                                                <div class="custom-control custom-radio custom-control-inline">
                                                                    <input   type="radio" id="reim" name="reim" class="custom-control-input" value="2" @if($expense_edit->  Reimbursable_amt ==2 )  checked @endif> <label class="custom-control-label p-3" for="customRadioInline1">Yes</label></div>
                                                            </span>
                                                            <span>
                                                                <div class="custom-control custom-radio custom-control-inline">
                                                                    <input type="radio" id="reim" name="reim" class="custom-control-input" checked="" value="1"  @if($expense_edit->  Reimbursable_amt ==1 )  checked @endif> <label class="custom-control-label p-3" for="customRadioInline1">No</label></div>
                                                            </span>
                                          ...
                                          <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-8">
                                                    <input type="number" class="form-control" id="reimbursable_amt" value="{{$expense_edit->  raimbs_amt}}" name="reimbursable_amt" {{$expense_edit->submit_status == 2?'readonly':''}}>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-8">
                                                    <select class="form-control" id="advance" name="advance">
                                                        <option value="1"  @if($expense_edit->  advanse ==1 )  Selected @endif>No Advance</option>
                                                         <option value="2"  @if($expense_edit->  advanse ==2 )  Selected @endif> Advance</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-8">
                                                    <input type="file" multiple="" name="receipt[]" id="receipt" class="form-control" style="height:auto">
                                                     ...
                                                     @if(!empty($expense_edit->upload_reciept))

                                                      <ul>
                                                        @foreach(explode(',',$expense_edit->upload_reciept) as $files)
                                                        <li>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-8">
                                                   <select class="form-control" id="status" name="status">
                                                       <option value="1"  @if($expense_edit->status ==1 )  Selected @endif>Submitted</option>
                                                       <option value="2"  @if($expense_edit->status ==2 )  Selected @endif>Reimburse</option>
                                                   </select>
                                                </div>
                                            </div>
                                        </div>
                                         ...
                                         <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-10">
                                                        <textarea class="form-control" id="desc" name="desc" rows="3">{{$expense_edit->desc}}</textarea>
                                                    </div>
                                                </div>
                                            </div>
