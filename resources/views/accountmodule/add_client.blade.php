                  ...
                  <div class="row align-items-center bredcrum-style">
                     <div class="col-sm-6">
                        ...
                        <ol class="breadcrumb">
                           ...
                           <li class="breadcrumb-item active"><a href="edit_organization.html">Add Organization</a></li>
                        </ol>
                     </div>
                     <div class="col-sm-6">
                                  ...
                                  <div class="form-group row">
                                      ...
                                      <div class="col-lg-8">
                                          <select class="form-control" name="lead_ownere" id="lead_ownere">
                                           ...
                                           <option value="{{$leadowners->id}}" >{{$leadowners->userfullname}}</option>
                                           @endforeach
                                             </select>
                                      </div>
                                  </div>
...
function client_edit(){
 var company = $('#company').val();
  ...
  $.ajax({
        ...
        type: "post",
        data: {"_token": _token,"company":company,"fname":fname,"website":website,"phone":phone,"lead_ownere":lead_ownere,"ac_type":ac_type,"address":address,"desc":desc},
        dataType: 'JSON',
