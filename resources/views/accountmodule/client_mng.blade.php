                  ...
                  <div class="row align-items-center bredcrum-style">
                     <div class="col-sm-6">
                        ...
                        <ol class="breadcrumb">
                           ...
                           <li class="breadcrumb-item active"><a href="client_mngt.html">Client Management</a>
                           </li>
                        </ol>
                     </div>
                     <div class="col-sm-6">
                        <a href="{{URL::to('add-client/')}}"><button class="btn btn-primary float-right">Add New Client</button></a>
                     </div>
                  </div>
               </div>
               <!-- end row -->
                     ...
                     <div class="card m-t-20">
                        ...
                        <tbody>
                            <tr title="View"> 
                                ...
                                <td>Rishabh</td>
                                <td>
                                    <a href="edit_organization.html"> <i class="mdi mdi-pen text-warning" title="Edit"></i></a>
                                </td>
                            </tr>
                        </tbody>
                    </table>
