		...
		<div class="page-title-box">
			...
			<div class="row align-items-center bredcrum-style">
				...
				<div class="col-sm-6 col-6">
					...
					<h3 class="page-title">Announcement Master</h3>

					<ol class="breadcrumb">

						<li class="breadcrumb-item"><a href="index.html">GRC</a></li>

						<li class="breadcrumb-item active"><a href="bill_master.html">Announcement Master</a>
							...
							<div class="col-sm-12">
								...
								<tbody>
									...
									<tr>
										...
										<td>{{$lists->desc}}</td>
										<td>
											<i title="View" class="mdi mdi-eye text-info" data-toggle="modal" data-target="#viewbill_{{$lists->id}}"></i>





					<i title="Edit" class="mdi mdi-pencil text-warning"  onclick="edit_bill('{{$lists->id}}','{{$lists->title}}','{{$lists->desc}}')" ></i>

                                   <a   onclick="return confirm('Are you sure you want to delete this ?');" href="{{URL::to('delete-annoucement-master')}}/{{$lists->id}}">
											<i title="Delete" class="mdi mdi-delete text-danger"></i>
                                                               ...
                                                               <div id="viewbill_{{$lists->id}}" class="modal fade" role="dialog">
                                                 ...
                                                 <div class="col-md-12">
                                                        <div class="form-group row m-0">
                                                               ...
                                                               <div class="col-lg-8 col-form-label">
                                                                      <label class="myprofile_label">{{$lists->title}}</label>
                                                               </div>
                                                        </div>
                                                 </div>
                                                 <div class="col-sm-12">
