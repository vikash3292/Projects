                ...
                <div class="container-fluid">
                    <div class="page-title-box">
                        <div class="row align-items-center bredcrum-style">
                            <div class="col-sm-6">
                                <h4 class="page-title">Edit Letter</h4>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="index.html">GRC</a></li>
                                    <li class="breadcrumb-item active"><a href="add_new_letter.html">Edit Letter</a>
                                    </li>
                                </ol>
                            </div>
                            <div class="col-sm-6">
                        ...
                        <div class="col-12">
                            <div class="card m-t-20">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-8">
                                                    <input id="letter_name" type="text" class="form-control" value="{{$edit_latter->latter_name }}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-8">
                                                    <input id="letter_type" type="text" class="form-control" value="{{$edit_latter->latter_type }}">
                                                    <span id ="letter_name_error"></span>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <textarea class="summernote" id="letter">{{$edit_latter->letter}}</textarea> 
...
<script language="javascript" type="text/javascript">
    function add_new_letter() {
       ...
       var letter_name = $('#letter_name').val();
        ...
        url: '/save_letter',
        type: "post",
        data: {"_token": _token,"letter_name":letter_name,"letter_type":letter_type,"letter":letter,"latter_id":latter_id},
        dataType: 'JSON',
