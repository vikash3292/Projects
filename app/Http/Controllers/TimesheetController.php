...
$totalweekCount =  !empty($totalweek)?count($this->getSundays($findYear,$month)):count($this->getSundays($findYear,$month));
 ...
 $time_arr =  array($duration->sun_duration??'00:00');
   ...
   $projectlista->user_hour_sat = second_to_hhmm($total_sat??'00:00');
   ...
   $assign_total_sun +=explode_time($time_val);
   ...
   $assign_total_sat +=explode_time($time_val);
   ...
   $projectlista->assign_hour_sun = second_to_hhmm($assign_total_sun??'00:00');
   ...
   $projectlista->assign_hour_sat = second_to_hhmm($assign_total_sat??'00:00');
   ...
   $time_arr =  array($projecthours->sun_duration??'00:00',$projecthours->mon_duration??'00:00',$projecthours->tue_duration??'00:00',$projecthours->wed_duration??'00:00',$projecthours->thu_duration??'00:00',$projecthours->fri_duration??'00:00',$projecthours->sat_duration??'00:00');
...
$timeStatus['sun_status'] =$request->noteDate[0];
...
$timeStatus['sat_project_status'] = $request->noteDate[6];

$timeStatus['sat_status'] = $request->noteDate[6];
