...
! function (a) {
    ...
    b.prototype = {
        ...
        submit: function (b) {
            ...
            this.isSaving = !0, a.when(this.save(e)).done(a.proxy(function (a) {
                ...
                var b;
                // var pencil='';
                // pencil="<i class='mdi mdi-pencil'></i>";
    ...
    function (a) {
        ...
        }), a.fn.editableform.buttons = '<button type="submit" class="btn btn-primary btn-sm editable-submit"><i class="mdi mdi-check"></i></button><button type="button" class="btn btn-secondary btn-sm editable-cancel"><i class="mdi mdi-close"></i></button>', a.fn.editableform.errorGroupClass = "has-error", a.fn.editableform.errorBlockClass = null, a.fn.editableform.engine = "bs3"
    }(window.jQuery),
    function (a) {
        "use strict";
